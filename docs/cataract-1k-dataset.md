...
> **Provenance note (PhacoSight):** this document is the dataset description from the
> upstream [Cataract-1K dataset-release repository](https://github.com/Negin-Ghamsarian/Cataract-1K),
> preserved here because PhacoSight is trained and evaluated on Cataract-1K. The citation,
> license, and download sections below are kept intact as required by the dataset's terms.
...
<img src="figures/cataract1k/Table1.png" alt=" Visualizations of phase annotations for 56 normal cataract surgeries. The durations of the videos are different and normalized for better visualization." width="1000">



<img src="figures/cataract1k/pie_chart.png" alt=" Total duration of the annotated phases in the 56 annotated cataract surgery videos (in seconds)." width="600">
...
<img src="figures/cataract1k/Figure3.png" alt=" Visualization of pixel-based annotations corresponding to relevant anatomical structures and instruments in cataract surgery and the challenges associated with different objects." width="1000">
...
<img src="figures/cataract1k/Table2.png" alt=" Number of instances and presence in the frames (% of the total number of frames in each fold)." width="1000">



**Table 3.** Average pixels corresponding to different labels per frame.

<img src="figures/cataract1k/Table3.png" alt="Average pixels corresponding to different labels per frame." width="1000">
...
<img src="figures/cataract1k/Figure4.png" alt="Intra-operative irregularities in cataract surgery." width="1000">
